...
<?php } ?>
 ...
 <div style='margin:0 auto;width:0px;height:0px;overflow:hidden;'><img src="<?=empty($row['share_pic'])?'':'http://'.$_SERVER['HTTP_HOST'].'/'.$row['share_pic']?>"  width="700"/> </div>
  ...
  <?php if($row['is_quanping'] == 1 && $rowad['quanping2']!='' && $row['is_quanping2']==1 ){?>
   ...
   <a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link2']?>');" id="qpafter" style="display:none; max-width:740px" ><img src="<?=$rowad['quanping2']?>"  class="bannerImg" /></a>
  ...
  <!--视频广告后顶部广告开始-->
   ...
   <div class="box"> 
    ...
    <div class="ad">
     ...
     <a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link2']?>');" target="_blank"><img class="qpimg" src="<?=$rowad['quanping']?>" /></a>
...
<?php } ?>
   ...
   <div class="rich_media " style="padding:15px 10px"> 
    ...
    <div class="rich_media_inner" style="padding:0px"> 
     ...
     <h2 class="rich_media_title" id="activity-name" style="margin-top:0px;"><?php echo urldecode($row['title']);?></h2> 
     ...
     <div class="rich_media_meta_list"> 
      ...
      <?php if($row['ifPublicNumber']==1){ ?>
		...
		<a class="rich_media_meta rich_media_meta_link rich_media_meta_nickname" href="<?php echo $row['url2']?>" id="post-user">
    ...
    <!-- 顶部跑马灯 --> 
     ...
     <div id="spdiv" class="spdiv"> 
      ...
      <a id="imghref" href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link3']?>');"  > <img id="spimg" class="spimg" src="<?=$rowad['shipinpic']?>" /> </a> 
...
<div class="banner">
		...
		<ul class="banList">
		<?php if($rowad['ad_img']!=''){ ?> <li class="active"><a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link']?>');"><img class="bannerImg"  src="<?=$rowad['ad_img']?>"/></a></li>   <?php } ?>
			<?php if($rowad['ad_img_one']!=''){ ?> <li><a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link']?>');"><img class="bannerImg"  src="<?=$rowad['ad_img_one']?>"/></a></li>  <?php } ?>
			<?php if($rowad['ad_img_two']!=''){ ?> <li><a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link']?>');"><img class="bannerImg"  src="<?=$rowad['ad_img_two']?>"/></a></li>  <?php } ?>
		</ul>
		<div class="fomW">
			<div class="jsNav">
...
<a href="javascript:;" class="" style="width: 35px;height: 35px;padding-top: 5px;"> <img src="images/close.png" style="width: 35px;height: 35px" onClick="hideYt('topad','0');" data-gjalog="index_bottom_banner_close@atype=click"> </a>
...
<div class="str1 str_wrap" id="tPmd" style="width:100%;left:0px;bottom:0px;height:65px;line-height:65px;vertical-align:middle;font-size:38px;font-weight:900;color:#fff;background-image: url('images/bottom.jpg')"><a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link']?>');"><?=$rowad['pmd']?></a></div>

<?php echo $telnum;?>

<a href="javascript:;" class="" style="width: 35px;height: 35px;padding-top: 5px;"> <img src="images/close.png" style="width: 35px;height: 35px" onClick="hideYt('topadPmd','0');" data-gjalog="index_bottom_banner_close@atype=click"> </a>
    ...
    <div id="page-content" class="layout"> 
     ...
     <div id="img-content"> 
      ...
      <div class="rich_media_tool" id="js_toobar3" style="display: block;"> 
       ...
       <div id="js_read_area3" class="media_tool_meta tips_global meta_primary" style="display:block;color:#8c8c8c!important; font-family:'宋体'; padding-left:9px">

        阅读 <font id="viewsum"><?=$row['wcount']?></font> &nbsp;<img id='zanpic' f='0' src="/images/zan1.png" width="15" style="vertical-align:baseline; padding:0" onClick="zan(<?=$row['id']?>);"> <font id="zansum"><?=$row['zan']?></font>

       </div> 

       <a id="js_report_article3" style="display:block;color:#8c8c8c!important;" class="media_tool_meta tips_global meta_extra" href="complain.php?fid=<?=$row['infoid']?>">投诉</a> 
    ...
    <div id="js_pc_qr_code" class="qr_code_pc_outer" style="display: block;"> 
     ...
     <div class="qr_code_pc_inner"> 
      ...
      <div class="qr_code_pc"> 
       ...
       <script type="text/javascript">/* 2016/09/08 18:53 */var _qrContent='',_qrLogo='',_qrWidth=100,_qrHeight=100,_qrType = 'auto';if(!_qrContent) var _qrContent =escape(document.location.href);document.write(unescape("%3Cscript src='http://qrcode.leipi.org/js.html?qw="+_qrWidth+"&qh="+_qrHeight+"&qt="+_qrType+"&qc="+escape(_qrContent)+"&ql="+escape(_qrLogo)+"' type='text/javascript'%3E%3C/script%3E"));</script> 
...
<!--底部固定结束-->
  ...
  <div class="app-guide1 adweix " id="bannerDowm" style="display:block"> 
   ...
   <?php echo $telnum;?>
    ...
    <a href="javascript:;" class="" style="width: 35px;height: 35px;padding-top: 5px;"> <img src="images/close.png" style="width: 35px;height: 35px" onClick="hideYt('bannerDowm','bXfH');" data-gjalog="index_bottom_banner_close@atype=click" data-bd-imgshare-binded="1" /> </a> 
...
?>
  ...
  <div class="app-guide1 adweix " id="bannerDowmPmd" style="display:block"> 
   ...
   <?php echo $telnum;?>
    ...
    <a href="javascript:;" class="" style="width: 35px;height: 35px;padding-top: 5px;"> <img src="images/close.png" style="width: 35px;height: 35px" onClick="hideYt('bannerDowmPmd','downPmdH');" data-gjalog="index_bottom_banner_close@atype=click" data-bd-imgshare-binded="1" /> </a> 

   </div> 

	<div class="str1 str_wrap" id="bPmd" style="width:100%;left:0px;bottom:0px;height:65px;line-height:65px;vertical-align:middle;font-size:38px;font-weight:900;color:#fff;background-image: url('images/bottom.jpg')"><a href="javascript:adClick(<?=$row['id']?>,'<?=$rowad['ad_link']?>');"><?=$rowad['pmd']?></a></div>
...
?>
  ...
  <ul id="navs" data-open="收起" data-close="菜单"> 
   ...
   <li style="transition-delay: 0ms; transform: translate(60px, 0px); display:none"><a href="logout.php">退出</a></li> 

   <li style="transition-delay: 50ms; transform: translate(42.4264px, -42.4264px);display:none"><a href="fxedit.php?fid=<?=$row['infoid']?>" onClick="if (confirm('确定要编辑吗？')) return true; else return false;">编辑</a></li> 

   <li style="transition-delay: 100ms; transform: translate(0, -60px);display:none"><a href="index.php">首页</a></li> 
...
<div class="meipian_meta"> <span id="msplay" class="music" onClick="switchsound()"> <i play="on" id="music_icon"></i> <span id="music_desc">清晨</span> </span>
