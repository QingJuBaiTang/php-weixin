...
return true;
 ...
 <form action="?act=add" method="post"  class="registerform"  name="newsform"onSubmit="return beforeSubmit(this);">
	...
	<dl class="clearfix">
			...
			<dd><input type="text" class="input_txt" id="userid" value="" name="userid"   placeholder="手机号" datatype="m" errormsg="请输入您的手机号码！">
        ...
        <dl class="clearfix">
			...
			<dd><input type="text" class="input_txt" style="width:calc(100% - 200px)" id="code" value="" name="code" placeholder="请输入验证码">
			<input type="button" style="height: 40px;line-height: 40px;color: #fff;font-size: 20px;text-align: center;border-radius: 5px;width: 160px; float:right;background-color: #66CCFF;border: none;border-bottom: 0px solid #a40000;margin: 0 auto;" id="send_code"  value="获取验证码">
			</dd>
...
<dl class="clearfix">
			...
			<dd><input name="shuyu" type="text" class="input_txt" id="shuyu" placeholder="填写您的上级ID" value="admin"  readonly="readonly"></dd>
