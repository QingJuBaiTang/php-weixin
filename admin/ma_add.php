...
<form action="" method="post" name="newsform" enctype="multipart/form-data">
    <div class="formbody">
        ...
        <ul class="forminfo">
            <?php if ($ma_arr) { ?>
                <li><label>生成的激活码</label><textarea class="textinput"
                                                   disabled="disabled"><?= $ma_arr ?></textarea><i></i></li>
            <?php } ?>
            <li><label>生成数量</label>
            ...
            <li><label>包含时间</label><input type="text" class="dfinput" name="tnum" style="width:80px"
                                          onkeyup="this.value=this.value.replace(/\D/g,'')"
                                          onafterpaste="this.value=this.value.replace(/\D/g,'')"/>&nbsp;&nbsp;天&nbsp;(不填写默认为30天)
            </li>
            <li><label>包含文章</label><input type="text" class="dfinput" name="wnum" style="width:80px"
                                          onkeyup="this.value=this.value.replace(/\D/g,'')"
                                          onafterpaste="this.value=this.value.replace(/\D/g,'')"/>&nbsp;&nbsp;篇&nbsp;(不填写默认为100篇)
            </li>
