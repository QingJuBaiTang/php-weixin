            ...
            <li style="float:right">
                <form name="searchsoft" method="post" action="?act=search">
                    ...
                    <input name="title" type="text" id="title" size="20" maxlength="50" class="dfinput"
                           style="width:200px;height:28px" placeholder="用户ID或姓名或QQ号"/>
        ...
        while ($row = mysql_fetch_array($query)) {
            ...
            <tr height="35px">
                ...
                <td><?= $rowcc['ccc'] ?>&nbsp;<? if ($rowcc['ccc'] > 0) { ?><a
                        href="artile.php?userid=<?= $row['userid'] ?>" class="tablelink">(查看文章)</a><?
                    } ?></td>
                <td><?= $row['qq'] ?></td>
                ...
                <td><?= $row['beizhu2'] ?></td>
                <td><a href="useredit.php?id=<?= $row['id'] ?>" class="tablelink">编辑</a> <a
                            href="userlist.php?id=<?= $row['id'] ?>&act=del"
