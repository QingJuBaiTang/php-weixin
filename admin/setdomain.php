...
<form action="?act=mod" method="post" name="newsform">
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li>
                <label>主域名：</label><input name="domain" type="text" class="dfinput"
                                          value="<?= $row['domain'] ?>"/><i></i></li>
            <li>
                <label>分享域名：</label><input name="fxdomain" type="text" class="dfinput" value="<?= $row['fxdomain'] ?>"/>多个|隔开<i></i>
            </li>
