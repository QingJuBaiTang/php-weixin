...
<form action="<?= $action ?>" method="post" name="newsform">
    ...
    <div class="formbody">
        ...
        <ul class="forminfo">
            <li><label>价格</label><input name="eprice" type="text" class="dfinput"
                                        value="<?= $row['eprice'] ?>" <? if ($id) {
                    echo 'disabled';
                } ?>/><i>元</i></li>
            <li><label>条数</label><input name="enums" type="text" class="dfinput" value="<?= $row['enums'] ?>"/><i>条</i>
            </li>
            <li><label>代理价格</label><input name="agentprice" type="text" class="dfinput"
                                          value="<?= $row['agentprice'] ?>"/><i>条</i></li>
