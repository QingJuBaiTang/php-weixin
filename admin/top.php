...
<ul class="nav">
    <li><a href="repass.php" target="rightFrame"><img src="images/icon06.png" title="修改密码"/>
            <h2>修改密码</h2></a></li>
</ul>
<?php if ($shuyu == "admin") { ?>
    <ul class="nav">
        <li><a href="setdomain.php" target="rightFrame"><img src="images/icon06.png" title="设置分享域名"/>
                <h2>设置分享域名</h2></a></li>
    </ul>
<?php } ?>
