...
<form method="post" name="newsform">
    ...
    <ul class="forminfo">
        <li><label>注册天数</label><input name="regtime" type="text" class="dfinput"
                                      value="<?= $regconfig['regtime'] ?>"/><i>填数字</i></li>
        <li><label>注册文章条数</label><input name="regnum" type="text" class="dfinput"
                                        value="<?= $regconfig['regnum'] ?>"/><i>填数字</i></li>
        <li><label>注册广告条数</label><input name="regadnum" type="text" class="dfinput"
                                        value="<?= $regconfig['regadnum'] ?>"/><i>填数字</i></li>
        <li><label>注册登陆设备</label><input name="reglognum" type="text" class="dfinput"
                                        value="<?= $regconfig['reglognum'] ?>"/><i>填数字</i></li>
