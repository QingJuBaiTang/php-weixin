...
<div class="apply" id="apply">
    ...
    <div class="padding:0px;">
        ...
        <form action="?act=add" method="post" class="registerform" name="newsform"
            ...
            <dl class="clearfix">
                <dd>账户：</dd>
                <dd><input type="text" class="input_txt" id="userid" value="" name="userid" placeholder="建议手机号"
            ...
            <dl class="clearfix">
                <dd>Q Q：</dd>
                <dd><input type="text" class="input_txt" id="qq" value="" name="qq" placeholder="用于密码找回"
                           datatype="*2-12" nullmsg="请设置QQ！" errormsg="请设置QQ！"></dd>
                <dd>
                    <div class="Validform_checktip"></div>
                </dd>
            </dl>
