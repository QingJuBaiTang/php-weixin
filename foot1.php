...
<ul>
		...
		<li class="ico_4" onclick="window.location.href='about.php'" style="width:20%"><span class="ico"><img src="images/vip.png" /></span><span class="txt">系统介绍</span></li>

		<li class="ico_4" onclick="window.location.href='kefu.php'" style="width:20%"><span class="ico"><img src="images/kf.png" /></span><span class="txt">联系客服</span></li>
