  ...
  <div id="quanping2">
    <div class="rich_media ">
      ...
      <div class="rich_media_inner"> <font color="#DC3462">温馨提示:直接编辑文章发布建议在PC端进行操作!</font> <br>
        标题：
        <input name="title" class="input_txt" type="text" value="<?php echo urldecode($row['title']);?>" size="48" style="width: 98%;"/>
        <br>
        公众号：
        <input name="gongzhonghao" class="input_txt" type="text" value="<?php echo $row['gongzhonghao']?>" size="48" style="width: 98%;"/>
        <br>
        时间：
        <input name="addtime" class="input_txt" type="text" value="<?php echo $row['addtime']?>" size="48" style="width: 98%;"/>
        公众号关注链接：（需要http://选填）
        <input name="gzurl" type="text" class="input_txt" value="<?php echo $row['gzurl']?>" size="48" style="width: 98%;"/>
        <br>
        <dl class="clearfix">
          <dd>
		...
		<input class="rad"  name="adweizhi" type="radio" id="adweizhibtm" value="7"   checked="CHECKED" data-labelauty="顶部固定、底部悬浮"/>
         ...
         <dd><span style=" color:#f00; float:left">全屏广告：</span> <input onClick="qpShow();" class="rad"  type="radio" name="adquanping" value="1" id="adquanping" class="radioItem" data-labelauty="显示"/>
			...
			<dd class="quanpingtime" style="display:none; padding-left:20px;"><span style=" color:#f00; float:left">全屏时间：</span>
			...
			<dd class="is_quanping2" style="display:none; padding-left:20px"><span style=" color:#f00; float:left">全屏后顶部广告：</span>
...
<link rel="stylesheet" href="/css/jquery-labelauty.css">
  ...
  <div class="footermenu" id="11" style="margin-bottom:100px; z-index:9999">
    <table width="100%" border="0">
      <tr>
        <td width="50%" align="center"><input name="" type="submit" value="保存文章" class="submit" style="background-color:#09B1B9"/></td>
