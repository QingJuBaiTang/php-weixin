<div class="bot_main">
    <ul>
        ...
        <li class="ico_4" onclick="window.location.href='vip.php'" style="width:20%"><span class="ico"><img
                        src="images/vip.png"/></span><span class="txt">在线充值</span></li>
        <li class="ico_5" id="umoreserver" onclick="Show_Hidden(tr1)" style="width:20%"><span class="ico"><a
                        href="#"><img src="images/hy.png"/></a></span><span class="txt">会员服务</span>
            <ul id="tr1">
