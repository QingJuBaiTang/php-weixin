...
<div class="apply" id="apply">
  ...
  <form action="<?php if(empty($row['id'])){ ?>?act=add<?php }else{ ?>?act=update<?php } ?>" id="signupok" method="post" name="addform" >
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['ad_title'])){ echo $row['ad_title']; } ?>" name="adtitle" id="adtitle" placeholder="请输入广告标题" style="height:50px;">
    ...
    <dd>
      ...
      <div style='margin-left:8px; margin-top:-5px; margin-right:10px; font-size:13px; color:#FF7F00;'> 说明：此标题不会在前台显示，仅用做自己区分广告内容。 </div>
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['ad_link'])){ echo $row['ad_link']; }else{ ?>#<?php } ?>" name="adlink" id="adlink" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="tel" class="input_txt" value="<?php if(!empty($row['adtelnumber'])){ echo $row['adtelnumber']; } ?>" name="adtelno" id="adtelno" placeholder="请输入联系电话" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="qq" class="input_txt" value="<?php if(!empty($row['adqqnumber'])){ echo $row['adqqnumber']; }?>" name="adqqno" id="adqqno" placeholder="请输入qq号" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="qq" class="input_txt" value="<?php if(!empty($row['adlbs'])){ echo $row['adlbs']; }?>" name="adlbslink" id="adlbslink" placeholder="请输入导航链接" style="height:50px;">
...
<!-- 广告图片二 -->
      ...
      <div class="add_upload">
          ...
          <div class="updiv"> 广告二:
            ...
            <div class="btn"> <span id="#btn_ad_img_one">添加图片</span>
              ...
              <div>
                ...
                <input id="fileupload_ad_img_one" type="file" name="mypic" onChange="uploadPic('ad_img_one')">
		...
		?>
            ...
            <a class='delimg' flag='ad_img_one' onclick='delPic(this);' rel='<?php echo $row['ad_img_one']?>'>删除</a>
...
<!-- 广告图片三 -->
      ...
      <div class="add_upload">
          ...
          <div class="updiv"> 广告三:
            ...
            <div class="btn"> <span id="#btn_ad_img_two">添加图片</span>
              ...
              <div>
                ...
                <input id="fileupload_ad_img_two" type="file" name="mypic" onChange="uploadPic('ad_img_two')">
		...
		?>
            ...
            <a class='delimg' flag='ad_img_two' onclick='delPic(this);' rel='<?php echo $row['ad_img_two']?>'>删除</a>
...
<br>
          ...
          <div class="updiv">
            ...
            <div class="btn"> <span id="#btn_erweima">添加图片</span>
              ...
              <div>
                ...
                <input id="fileupload_erweima" type="file" name="mypic" onChange="uploadPicErweima('erweima')">
          ...
          <div class="updiv">
            ...
            <div class="btn"> <span id="#btn_quanping">添加图片</span>
              ...
              <div>
                ...
                <input id="fileupload_quanping" type="file" name="mypic" onChange="uploadPicQuan('quanping')">
	...
	<dl class="clearfix">
      ...
      <div class="add_upload">
          ...
          <div class="updiv">
            ...
            <div class="btn"> <span id="#btn_quanping2">添加图片</span>
              ...
              <div>
                ...
                <input id="fileupload_quanping2" type="file" name="mypic" onChange="uploadPic('quanping2')">
		...
		?>
            ...
            <input type="hidden" value="<?php echo $row['quanping2']?>"  name="quanping2" id="quanping2">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['ad_link2'])){ echo $row['ad_link2']; }?>" name="adlink2" id="adlink2" placeholder="请输入广告链接（包含：http://）" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <div class="add_upload">
          ...
          <div class="updiv"> 
            ...
            <div class="btn"> <span id="#btn_shipinpic">添加图片</span>
              ...
              <div>
                ...
                <input id="fileupload_shipinpic" type="file" name="mypic" onChange="uploadPicQuan('shipinpic')">
		...
		?>
            ...
            <input type="hidden" value="<?php echo $row['shipinpic']?>"  name="shipinpic" id="shipinpic">
	...
	<dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['ad_link3'])){ echo $row['ad_link3']; }?>" name="adlink3" id="adlink3" placeholder="请输入广告链接（包含：http://）" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['pmd'])){ echo $row['pmd']; }?>" name="pmd" id="pmd" placeholder="输入跑马灯内容" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['wechat_name'])){ echo $row['wechat_name']; }?>" name="wechat_name" id="wechat_name" placeholder="输入公众号名称" style="height:50px;">
    ...
    <dl class="clearfix">
      ...
      <dd>
        ...
        <input type="text" class="input_txt" value="<?php if(!empty($row['wechat_url'])){ echo $row['wechat_url']; }?>" name="wechat_url" id="wechat_url" placeholder="输入公众号关注链接" style="height:50px;">
    ...
    <div class="btn_box" style="margin-bottom:50px;">
      ...
      <input type="name" name="signup" class="button" value="确认提交"  style="background-color:#09B1B9" onClick="return postcheck();">
...
.btn{position: relative;overflow: hidden;margin-right: 4px;display:inline-block;*display:inline;padding:4px 10px 4px;font-size:14px;line-height:18px;*line-height:20px;color:#fff;text-align:center;vertical-align:middle;cursor:pointer;background-color:#09B1B9;border:1px solid #cccccc;border-color:#e6e6e6 #e6e6e6 #bfbfbf;border-bottom-color:#b3b3b3;-webkit-border-radius:4px;-moz-border-radius:4px;border-radius:4px;}
...
.delimg{margin-left:20px; cursor:pointer;
